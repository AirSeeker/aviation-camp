...
Immediately but
As the airplane’s speed
to lending atthud3
level flight attitude
smoothly retard the throttle,
continues to decrease,
until the main wheels
and hold sufficient forward
the tail may be allowed to
eee) a
touch. The tailwheel
elevator pressure to hold the main
slowly touch the ground.
should be held clear of
