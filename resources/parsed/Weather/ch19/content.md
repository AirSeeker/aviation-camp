...
currents frequently occur over broader areas than do the upward currents; therefore, they have a slower
...
convective current. A pilot can expect to encounter turbulence beneath or in the clouds, while above the
...
Wind shear is defined in Section 19.2.4. Wind shear generates turbulence between two wind currents of
...
jet core. This is known as wind shear. It is not the wind speed itself that causes CAT; it is the wind shear
...
velocities that exceed the climb capability of the aircraft, particularly for airplanes with high wing and
...
turbulence. Similar wind enhancements can be anticipated near the slopes of an isolated peak. In contrast,
