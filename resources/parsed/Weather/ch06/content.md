...
evaporate the liquid, thereby removing heat and cooling the body. The same effect can be seen when
...
6.2.2 Transpiration
Transpiration is the evaporation of water from plants. In most plants, transpiration is a passive process
...
6.2.5 Condensation
Condensation is the phase transition by which vapor (a gas) is changed into a liquid. In the atmosphere,
...
which are associated with the absorption of latent heat by water from the environment (melting,
