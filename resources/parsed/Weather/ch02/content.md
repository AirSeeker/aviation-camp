...
NASA, and commercial aviation weather providers.
...
Oceanic flight information regions (FIR), and southward through Central America and the Caribbean to
10° S in South America.
...
information for international flights through the World Area Forecast System (WAFS) grids which are used
to support the Internet File Service (WIFS), which is a separate system.
2.2.2.1.3
...
of America, and tropical eastern Pacific. In support of ICAO, the NHC is also referred to as a Tropical
...
WFO is a multipurpose, local weather forecast center that produces, among its suite of services,
aviation-related products. In support of aviation, WFOs issue Terminal Aerodrome Forecasts (TAF) and
Aviation Forecast Discussions (AFD), with some offices issuing Airport Weather Warnings (AWW),
Soaring Forecasts, and Balloon Forecasts. The WFO also issues weather warnings such as tornado and
...
The ATCSCC utilizes the Traffic Management System (TMS), aircraft situation displays, monitor alert,
...
Because weather is the most common reason for air traffic delays and rerouting, NWS meteorologists
...
(TRACON), Central Radar Approach (CERAP)
...
The FAA delivers flight services to pilots in the CONUS, Alaska, Hawaii, and Puerto Rico. For pilots in
the CONUS, services are available by phone at 1-800-WX-BRIEF (1-800-992-7433). For pilots in Alaska
call 1-833-AK-BRIEF (1-833-252-7433). Services include, but are not limited to, pre-flight weather
briefings, flight planning, and in-flight advisory services.
...
Cameras website (found in Appendix G). See Section 3.3.3.2 and Section 24.9 for additional information.
...
Commercial providers also produce forecasts, analyses, and other proprietary weather products that may
