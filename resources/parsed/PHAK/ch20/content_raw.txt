...
driven pump that is mounted on the accessory case of the
...
An adjustment knob is provided with which the pilot may move
illustrated in Figure 8-24. Most banking scale indicators on the
the miniature aircraft up or down to align the miniature aircraft with
top of the instrument move in the same direction from that in
the horizon bar to suit the pilot’s line of vision. Normally, the
which the aircraft is actually banked. Some other models move
miniature aircraft is adjusted so that the wings overlap the horizon
bar when the aircraft is in straight-and-level cruising flight.
in the opposite direction from that in which the aircraft is
actually banked. This may confuse the pilot if the indicator is used
to determine the direction of bank. This scale should be used only
The pitch and bank limits of an attitude indicator depend upon
to control the degree of desired bank. The relationship of the
the make and model of the instrument. Some attitude indicators
miniature aircraft to the horizon bar should be used for an indication
have limits in the banking plane from 100° to 110°, and the pitch
of the direction of bank. The attitude indicator is reliable and the
...
exceeds these limits. This may be extremely hazardous when the
Heading Indicator
aircraft is operating in instrument meteorological conditions or
The heading indicator is fundamentally a mechanical
confuse a pilot during an unusual attitude recovery. A number of
