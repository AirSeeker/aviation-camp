...
a number inside of a box
. To differentiate distances when
...
traffic flow. When a holding pattern is charted,
Holding Pattern
1-10
...
When a triangle containing an “A” (
...
the center depicts an obstacle (
...
is also represented as a thick, solid line (
feeder route is depicted with a medium line (
